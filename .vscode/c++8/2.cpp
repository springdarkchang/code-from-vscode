...
public:
    Me(string name1, char gender1, string name2, char gender2, string name3, char gender3, string name4, char gender4, Brother tbro, Sister tsis) : Father(name1, gender1, name2, gender2, name3, gender3), Bro(tbro), Sis(tsis), Mname(name4), Mgender(gender4) { cout << "The Me is constructed!" << endl; }
    void displayMe()
    {
        displayFather();
        Bro.displayMyself();
