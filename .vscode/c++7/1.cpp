...
public:
    Distance() {}
    double MemberDistance(Point &, Point &);
};
class Point
{
    double x, y;
...
public:
    ...
    friend double ExternalDistance(Point &, Point &);
    friend double Distance::MemberDistance(Point &, Point &);
...
int main()
{
    ...
    Distance d2;
    cout << "The distance between two points calculated with friend class is: " << d2.MemberDistance(p5, p6) << endl;
}
