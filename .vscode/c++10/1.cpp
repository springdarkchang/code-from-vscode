...
public:
    Sofa(int t1, int t2, int t3, int t4) : Furniture(t1, t2), sofacapacity(t3), sofaweight(t4) { CanSit(); }
    void CanSit()
    {
...
public:
    ...
    void CanLie()
    {
        cout << "The bed weights " << bedweight << " and can lie " << bedcapacity << " persons." << endl;
    }
};
...
public:
    ...
    void ItsFunction() { cout << "The sofabed uses " << Sofa::wamount + Bed::wamount << " pieces woods and "
                              << Sofa::mamount + Bed::mamount << " pieces mentals,"
                              << "and weights " << sofaweight + bedweight
                              << " and can accommodate " << sofacapacity + bedcapacity << " persons." << endl; }
};
int main() 
{
